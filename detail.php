 ...
 <?php 
		  ...
		  <div class="card-body">
		    ...
		    ?>
						   ...
						   <div class="  bip">
						<?php  $query = $conn->query("SELECT * FROM produk WHERE categori = 1"); ?>
							...
							<p class="Price">  <a class="btn btn-warning ml-4"   href="beli.php?id_produk=<?= $a['id_produk'];?>"><i class="fas fa-shopping-cart"></i></a> 
							 <a  class="btn v btn-success ml-2" href=" detail.php?id=<?= $a['id_produk'];?>"  >
